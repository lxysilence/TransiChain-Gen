...
public class Main_TransiChain {
    public static void main(String[] args) {
        long startTime = System.currentTimeMillis();
        Code02_TrieTree_TransiChain trie = new Code02_TrieTree_TransiChain();
        ...
        // 2. 深拷贝原始树状态（加噪前）
        Code02_TrieTree_TransiChain originalTree = trie.copyTree();
...
//        double mutualInfo = Code02_TrieTree_RCDP.calculateMutualInformation(originalTree.root, trie.root);
        double mutualInfo = Code02_TrieTree_TransiChain.calculateNormalizedMutualInformation(originalTree.root, trie.root);
...
// 直接生成数据到文件（避免内存溢出）
        ...
        Code02_TrieTree_TransiChain.generateWordsFromTrieToFile(trie, originalTree,outputPath);
        // 记录程序结束时间
