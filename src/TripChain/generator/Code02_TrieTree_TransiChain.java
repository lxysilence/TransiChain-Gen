...
public class Code02_TrieTree_TransiChain {

    public Node root;
    private int originalSize; // 新增字段，记录原始数据总数

    //构造函数，初始化根节点
    public Code02_TrieTree_TransiChain() {
        this.root = new Node();
        this.originalSize = 0;
    }
    ...
    // 深拷贝整棵树
    public Code02_TrieTree_TransiChain copyTree() {
        Code02_TrieTree_TransiChain copy = new Code02_TrieTree_TransiChain();
...
//    }
    ...
    public static void generateWordsFromTrieToFile(Code02_TrieTree_TransiChain trie, Code02_TrieTree_TransiChain copy, String outputPath) {
